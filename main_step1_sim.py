<<<<<<< Updated upstream:main_step1_sim.py
=======
<<<<<<< Updated upstream:main_step1_simulation.py
# --------------------------------------------
...
main()
=======
>>>>>>> Stashed changes:main_step1_simulation.py
# --------------------------------------------
#  EMT solver main function
#  2020-2024 Bin Wang, Min Xiong, Deepthi Vaidhynathan, Jonathan Maack
#  Last modified: 8/15/24
...
=======
    # WILLYEDIT
    DSrate = 50 #10 # down sampling rate, i.e. results saved every DSrate sim steps.
>>>>>>> Stashed changes:main_step1_simulation.py
...
<<<<<<< Updated upstream:main_step1_sim.py
=======
>>>>>>> Stashed changes:main_step1_sim.py
>>>>>>> Stashed changes:main_step1_simulation.py
