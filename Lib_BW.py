...
class EmtSimu():
    ...
    def updateXibr(self, pfd, dyd, ini, ts):
        self.x_ibr_pv_1 = numba_updateXibr(
            ...
            dyd.ibr_regca_Volim,dyd.ibr_regca_Khv,dyd.ibr_regca_Lvpnt0,dyd.ibr_regca_Lvpnt1,dyd.ibr_regca_Tg,dyd.ibr_regca_Iqrmax,dyd.ibr_regca_Iqrmin,dyd.ibr_regca_Tfltr,dyd.ibr_regca_Zerox,dyd.ibr_regca_Brkpt,dyd.ibr_regca_Rrpwr,
            dyd.ibr_reecb_PQFLAG,dyd.ibr_reecb_PFFLAG,dyd.ibr_reecb_VFLAG,dyd.ibr_reecb_QFLAG,dyd.ibr_reecb_Imax,dyd.ibr_reecb_Vdip,dyd.ibr_reecb_Vup,dyd.ibr_reecb_Trv,dyd.ibr_reecb_dbd1,dyd.ibr_reecb_dbd2,dyd.ibr_reecb_Kqv,
            dyd.ibr_reecb_Iqll,dyd.ibr_reecb_Iqhl,dyd.ibr_reecb_Tp,dyd.ibr_reecb_Qmin,dyd.ibr_reecb_Qmax,dyd.ibr_reecb_Kqp,dyd.ibr_reecb_Kqi,dyd.ibr_reecb_Vmin,dyd.ibr_reecb_Vmax,dyd.ibr_reecb_Kvp,dyd.ibr_reecb_Kvi,dyd.ibr_reecb_Tiq,
            dyd.ibr_reecb_dPmin,dyd.ibr_reecb_dPmax,dyd.ibr_reecb_Pmin,dyd.ibr_reecb_Pmax,dyd.ibr_reecb_Tpord,
            dyd.ibr_repca_FFlag,dyd.ibr_repca_VCFlag,dyd.ibr_repca_RefFlag,dyd.ibr_repca_fdbd1,dyd.ibr_repca_fdbd2,dyd.ibr_repca_Ddn,dyd.ibr_repca_Dup,dyd.ibr_repca_Tp,dyd.ibr_repca_femin,dyd.ibr_repca_femax,dyd.ibr_repca_Kpg,
            dyd.ibr_repca_Kig,dyd.ibr_repca_Pmin,dyd.ibr_repca_Pmax,dyd.ibr_repca_Tg,dyd.ibr_repca_Rc,dyd.ibr_repca_Xc,dyd.ibr_repca_Kc,dyd.ibr_repca_Tfltr,dyd.ibr_repca_dbd1,dyd.ibr_repca_dbd2,dyd.ibr_repca_emin,dyd.ibr_repca_emax,
            dyd.ibr_repca_Vfrz,dyd.ibr_repca_Kp,dyd.ibr_repca_Ki,dyd.ibr_repca_Qmin,dyd.ibr_repca_Qmax,dyd.ibr_repca_Tft,dyd.ibr_repca_Tfv,
